...
public class DropDownMenu extends LinearLayout {
    ...
    private void init(Context mContext, AttributeSet attrs) {
        ...
        mRlShadow.setBackgroundColor(Color.TRANSPARENT);
...
//        mShowCheck = true;
//        mShowDivider = true;
//        mCheckIcon = R.mipmap-xxhdpi.drop_down_item_select_icon;
//        mUpArrow = R.mipmap-xxhdpi.drop_down_selected_icon;
//        mDownArrow = R.mipmap-xxhdpi.drop_down_unselected_icon;
